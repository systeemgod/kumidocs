...
const KumiEmojiComponent = (allProps: Record<string, unknown>): JSX.Element => {
	...
	let emoji = '';
	if (nodeData && typeof nodeData.properties.dataEmoji === 'string') { emoji = nodeData.properties.dataEmoji; }
	if (emoji) { return <EmojiIcon emoji={emoji} size="1.07lh" className="align-middle" />; }
	return <></>;
};
