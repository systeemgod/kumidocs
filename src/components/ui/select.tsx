...
const SelectScrollUpButton = (allProps: ComponentProps<typeof SelectPrimitive.ScrollUpButton>): JSX.Element => {
...
const SelectScrollDownButton = (allProps: ComponentProps<typeof SelectPrimitive.ScrollDownButton>): JSX.Element => {
	const { className } = allProps;
	return (
...
const SelectSeparator = (allProps: ComponentProps<typeof SelectPrimitive.Separator>): JSX.Element => {
	const { className } = allProps;
	return (
